...
// 	Float64 det = (m.c0.x * (m.c1.y * m.c2.z - m.c2.y * m.c1.z) +
// 									m.c1.x * (m.c2.y * m.c0.z - m.c0.y * m.c2.z) +
// 									m.c2.x * (m.c0.y * m.c1.z - m.c1.y * m.c0.z));
// 	if (det == 0.0)
// 		return Matrix64();

// 	det = 1.0 / det;
// 	mi.off.x = (m.c1.x * (m.off.y * m.c2.z - m.c2.y * m.off.z) +
// 							m.c2.x * (m.off.z * m.c1.y - m.off.y * m.c1.z) +
// 							m.off.x * (m.c2.y * m.c1.z - m.c1.y * m.c2.z)) * det;
// 	mi.off.y = (m.c2.x * (m.off.y * m.c0.z - m.c0.y * m.off.z) +
// 							m.off.x * (m.c0.y * m.c2.z - m.c2.y * m.c0.z) +
// 							m.c0.x * (m.c2.y * m.off.z - m.off.y * m.c2.z)) * det;
// 	mi.off.z = (m.off.x * (m.c1.y * m.c0.z - m.c0.y * m.c1.z) +
// 							m.c0.x * (m.c1.z * m.off.y - m.c1.y * m.off.z) +
// 							m.c1.x * (m.off.z * m.c0.y - m.off.y * m.c0.z)) * det;
